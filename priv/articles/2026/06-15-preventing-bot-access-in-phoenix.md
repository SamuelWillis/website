...
using the content I create for.
...
I ended up using in my [Phoenix based website](https://github.com/SamuelWillis/website)
you are currently reading this article on.

Examples will focus on AI Bots but the techniques can be applied to any
...
While the above is by no means perfect, it's a really great start and as per
usual Phoenix makes this stuff ez-pz.

As always, there's plenty of other options but I wanted to show how these things
can be easily added to your existing web application with relatively little
lift.
